plugins {
    id("java")
    id("com.github.nagyesta.abort-mission-gradle-plugin") version "5.2.73"
}
...
dependencies {
    ...
    testImplementation("org.junit.platform:junit-platform-engine:6.1.2")
    testImplementation("org.junit.platform:junit-platform-launcher:6.1.2")
    // HINT: Add Booster to integrate Abort-Mission
    testImplementation("com.github.nagyesta.abort-mission.boosters:abort.booster-cucumber-jvm:7.1.50")
}
