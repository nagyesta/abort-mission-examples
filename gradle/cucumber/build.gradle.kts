plugins {
    id("java")
    id("com.github.nagyesta.abort-mission-gradle-plugin") version "5.2.4"
}
...
dependencies {
    ...
    testImplementation("io.cucumber:cucumber-picocontainer:7.32.0")
    ...
    testImplementation("com.github.nagyesta.abort-mission.boosters:abort.booster-cucumber-jvm:6.1.33")
}
