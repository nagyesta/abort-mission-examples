plugins {
    id("java")
    id("com.github.nagyesta.abort-mission-gradle-plugin") version "5.1.2"
}
...
dependencies {
    ...
    testImplementation("io.cucumber:cucumber-picocontainer:7.22.1")
    ...
    testImplementation("com.github.nagyesta.abort-mission.boosters:abort.booster-cucumber-jvm:6.0.11")
}
