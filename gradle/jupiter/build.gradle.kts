plugins {
    id("java")
    id("com.github.nagyesta.abort-mission-gradle-plugin") version "4.1.12"
}
...
dependencies {
    ...
    testImplementation("com.github.nagyesta.abort-mission.boosters:abort.booster-junit-jupiter:4.2.30")
}
